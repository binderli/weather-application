...
public class YahooParser {
	...
	public Weather parse(InputStream inputStream)
		...
		weather.setCity(doc.valueOf(
				"/query/results/channel/yweather:location/@city"));
		weather.setRegion(doc.valueOf(
				"/query/results/channel/yweather:location/@region"));
		weather.setCountry(doc.valueOf(
				"/query/results/channel/yweather:location/@country"));
		...
		weather.setChill(doc.valueOf(
				"/query/results/channel/yweather:wind/@chill"));
